"""``amyloids-widemerge`` — merge standard CSVs and optionally validate vs BHT reference."""
...
examples:
  ...
  amyloids-widemerge parsed/*.csv --fasta RPS2.fasta -o out.csv \\
      --reference ../all/RPS2_human_all.csv

  amyloids-widemerge --input-dir parsed/ -o out.csv --check-bht-reference \\
      --reference-name RPS2_human_all.csv

difference vs amyloid-merge:
  amyloid-merge          fast merge only
  amyloids-widemerge     merge + optional BHT reference score validation
